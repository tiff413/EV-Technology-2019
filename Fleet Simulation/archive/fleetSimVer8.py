...
filename = "shift2"
allShiftsDF = pd.read_csv("ver7/schedules/" + filename + ".csv", sep=";", index_col=None)
pricesDF = pd.read_csv("ver8/prices.csv", sep=";", index_col=None)
drivingDF = pd.read_csv("ver7/drivingDataLowMpkw.csv", sep=";", index_col=None)
fleetData = pd.read_csv("ver8/fleetDataVer8.csv", sep=";", index_col=None)

# SELECT FLEET DATA
fleetData = selectCase(fleetData, {
    'smallCars':4, 'mediumCars':0, 'largeCars':0,
    'slowChargePts':0, 'fastChargePts':2, 'rapidChargePts':0
})
